...
export const metadata: Metadata = {
  title: "Grand Luxe Hotel - Luxury Accommodations in the City",
  description: "Experience unparalleled luxury at Grand Luxe Hotel. Premium rooms, world-class amenities, and exceptional service in the heart of the city.",
  keywords: "luxury hotel, premium accommodations, city hotel, spa, fine dining, business travel",
  openGraph: {
    title: "Grand Luxe Hotel - Luxury Accommodations",
    description: "Experience unparalleled luxury at Grand Luxe Hotel. Premium rooms, world-class amenities, and exceptional service in the heart of the city.",
    siteName: "Grand Luxe Hotel",
    type: "website",
    images: [
      {
        url: "https://images.pexels.com/photos/189295/pexels-photo-189295.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
        alt: "Grand Luxe Hotel elegant lobby"
      }
    ]
  },
  twitter: {
    ...
    title: "Grand Luxe Hotel - Luxury Accommodations",
    description: "Experience unparalleled luxury at Grand Luxe Hotel. Premium rooms, world-class amenities, and exceptional service.",
